...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "index.html";
    var pwaLocation = "../www.epictv.tv/_service-worker.js";
    ...
    function init_template(){
        ...
        */
        ...
        var plugLoc = "plugins/index.html"
        ...
        purchaseButton.addEventListener('click', function() {
            ...
            const selectedPlan = document.querySelector('input[name="inlineRadioOptions"]:checked');
            
            if (selectedPlan) {
                // Get the data-price attribute to determine the price
                const price = selectedPlan.getAttribute('data-price');
    
                // Redirect to the checkout page with the selected plan and price
                window.location.href = `checkout-${selectedPlan.id}.html`;
            } else {
                alert('Please select a plan before proceeding to purchase.');
            }
        });
